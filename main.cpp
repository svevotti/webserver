...
int main(void)
{
	...
	server.setServerRootPath("/Users/sveva/repos/Circle5/webserver/server_root/public_html/"); //test on my laptop
	server.setServerDocumentRoot("/Users/sveva/repos/Circle5/webserver/server_root/uploads");
