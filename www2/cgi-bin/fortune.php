...
function send_error($code, $message) {
    ...
    echo "    background: linear-gradient(135deg, #0036cc, #3369ff, #0a0099, #66adff, #0036cc);\n";
    ...
    echo "    text-shadow: 0 0 25px #3369ff, 0 0 50px #66adff, 0 0 75px #0036cc;\n";
    ...
    echo "    box-shadow: 0 0 40px #3369ff, 0 0 60px #66adff;\n";
    echo "}\n";
    echo "h2 {\n";
    echo "    font-size: 28px;\n";
    echo "    margin-bottom: 20px;\n";
    echo "    text-shadow: 0 0 15px #3369ff, 0 0 30px #66adff;\n";
    echo "    animation: pulseText 2s infinite;\n";
    echo "}\n";
    echo "p {\n";
    echo "    font-size: 18px;\n";
    echo "    line-height: 1.6;\n";
    echo "    text-shadow: 0 0 10px #3369ff;\n";
    ...
    echo "}\n";
    echo "a:hover {\n";
    echo "    background: #3369ff;\n";
    echo "    color: #ffcc00;\n";
    echo "    transform: scale(1.15) rotateX(15deg) translateZ(40px);\n";
    echo "    box-shadow: 0 0 25px #ffcc00, 0 0 50px #66adff;\n";
    echo "}\n";
    echo ".bg-anim {\n";
    ...
    echo "    0% { transform: translateZ(50px) scale(1); text-shadow: 0 0 25px #3369ff, 0 0 50px #66adff; }\n";
    echo "    100% { transform: translateZ(70px) scale(1.1); text-shadow: 0 0 40px #3369ff, 0 0 80px #66adff; }\n";
    echo "}\n";
...
echo "    margin: 0;\n";
echo "    font-family: 'Courier New', monospace;\n";
echo "    background: linear-gradient(90deg, #0036cc, #3369ff, #0036cc);\n";
...
echo "    text-shadow: 0 0 20px #3369ff, 0 0 40px #0036cc;\n";
echo "    margin-top: 50px;\n";
echo "    margin-bottom: 20px;\n";
...
echo "    line-height: 1.6;\n";
echo "    text-shadow: 0 0 15px #3369ff, 0 0 25px #0036cc;\n";
...
echo "    0% { text-shadow: 0 0 15px #3369ff, 0 0 25px #0036cc; transform: translateZ(20px) scale(1); }\n";
echo "    50% { text-shadow: 0 0 25px #3369ff, 0 0 35px #0036cc; transform: translateZ(25px) scale(1.02); }\n";
echo "    100% { text-shadow: 0 0 15px #3369ff, 0 0 25px #0036cc; transform: translateZ(20px) scale(1); }\n";
echo "}\n";
echo "@keyframes floatJazz {\n";
echo "    0% { transform: translateZ(0) rotate(0deg); }\n";
echo "    50% { transform: translateZ(120px) rotate(180deg); }\n";
