...
class ClientRequest;  // Forward declaration for parsed request data
class Server;         // Forward declaration for H’s Server
...
class CGI {
    ...
    private:
        ...
        std::string _request_method;  // REQUEST_METHOD (GET or POST)
        ...
        static const std::string SCRIPT_BASE_DIR;  // Fallback if Server::_root unavailable
    ...
    public:
        ...
        const std::vector<struct pollfd>& getPollFds() const { return _poll_fds; }
